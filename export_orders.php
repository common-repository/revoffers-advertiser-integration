<?php
/**
 * Order Data exporter for RevOffers historical upload.
 *
 * Usage:
 * $ php export_orders.php | gzip > TMP_OrderDataForRevOffers.json.gz
 *
 * RevOffers needs to import historical order information to correctly attribute new orders
