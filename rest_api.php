 ...
 * RevOffers. By being able to receive these events, we hope Advertisers
...
$routes = [
    ...
    /**
     * RevOffers sometimes needs to be able to exclude/ignore existing customers or orders.
    ...
    /**
     * When RevOffers Attribution Engine converts an order, this endpoint will be used
    ...
    /**
     * RevOffers provides product catalogs to affiliates WHEN AUTHORIZED. This endpoint
